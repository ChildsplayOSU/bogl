...
This is a running example, so congrats on writing your first Spiel program! If you haven't already you can try it out in our [online tool](https://bogl.engr.oregonstate.edu/) to verify everything works as expected. If not take a moment to go back and double check the steps.
